# ====================================================================================
# Setup Project
PROJECT_NAME := provider-stackrox
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Stackrox CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Stackrox controllers
...
# This target prepares repo for your provider by replacing all "stackrox"
